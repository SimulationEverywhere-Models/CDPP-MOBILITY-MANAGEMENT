...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  gateway.o gatewayqueue.o mobilitymodule.o register.o transceiver.o transqueue.o tupleclient.o tuplequeue.o tupleserver.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
gateway.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/gateway.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
gatewayqueue.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/gatewayqueue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
mobilitymodule.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/mobilitymodule.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
transceiver.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/transceiver.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
transqueue.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/transqueue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
tupleclient.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleclient.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
tuplequeue.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/tuplequeue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
tupleserver.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleserver.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
gateway.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/gateway.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/gateway.h \
...
gatewayqueue.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/gatewayqueue.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/gatewayqueue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
mobilitymodule.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/mobilitymodule.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/mobilitymodule.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/mobilitymngmt/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/gateway.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleclient.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleserver.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tuplequeue.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transceiver.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/mobilitymodule.h \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transqueue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/queue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/cpu.h
transceiver.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transceiver.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transceiver.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
transqueue.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transqueue.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/transqueue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
tupleclient.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleclient.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleclient.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
tuplequeue.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tuplequeue.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tuplequeue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
tupleserver.o: \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleserver.cpp \
 /cygdrive/C/eclipse/workspace/mobilitymngmt/tupleserver.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
